...
class EstudianteGrupoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estdudiante Grupo creado exitosamente');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estdudiante Grupo modificado exitosamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success', 'Estdudiante Grupo eliminado exitosamente');
    }
}
